...
public class Q04_LocalDate02 {
    public static void main(String[] args) {
        ...
        /*
           ...
           A. new LocalDate(2014, 5, 21);   new keywordu yoktur LocalDate 'te
           B. new LocalDate(2014, 6, 21);   new keywordu yoktur LocalDate 'te
           C. LocalDate.of(2014, 5, 21);  5. ay dedigi icin bu da olmaz
